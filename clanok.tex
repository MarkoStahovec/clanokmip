...
Nemožno zabúdať aj na fakt, že mobilné zariadenia nie sú vyrábané primárne ako učebná pomôcka, a preto je niekedy náročné nájsť vhodný spôsob ako ich využívať. Pri implentácií MALL by sa mal brať do úvahy aj sociálny kontakt, ktorý je značne obmedzený pri používaní mobilného zariadenia.

Ďalšou charakteristickou črtou moderných aplikácií pre štúdium je aj to, že časť z nich nie je zadarmo, čo v prípade kníh poskytnutých školou nemusí platiť. Problémom takýchto aplikácií býva aj to, že podporujú osobné učenie v súkromií, no nepodporujú individuálne prispôsobenú výučbu.
